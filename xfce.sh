...
wget https://github.com/C2549Puppet/E_-/blob/I/ubchromiumfix.sh && chmod +x ubchromiumfix.sh
...
vncpasswd
wget -q https://github.com/C2549Puppet/E_-/blob/I/.profile -O $HOME/.profile.1 > /dev/null
