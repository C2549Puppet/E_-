...
wget https://raw.githubusercontent.com/C2549Puppet/E_-/I/ubchromiumfix.sh && chmod +x ubchromiumfix.sh
...
vncpasswd
wget -q https://raw.githubusercontent.com/C2549Puppet/E_-/I/.profile -O $HOME/.profile.1 > /dev/null
